...
source = 'C:/Users/むずでょ/source/repos/tic-tac-toe-on-golang'
destination = 'C:/Users/むずでょ/Documents/GitHub/tic-tac-toe-on-golang'
...
def go():
    ...
    print('Trace   | Copy.')
    copy_dir('/src', ignore=shutil.ignore_patterns('*.log', '__debug_bin'))
    copy_file('/.gitignore')
